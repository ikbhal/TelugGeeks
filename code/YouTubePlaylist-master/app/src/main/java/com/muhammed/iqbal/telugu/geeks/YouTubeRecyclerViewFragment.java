...
import com.muhammed.iqbal.telugu.BuildConfig;
...
public class YouTubeRecyclerViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(com.muhammed.iqbal.telugu.R.layout.youtube_recycler_view_fragment, container, false);

        mRecyclerView = rootView.findViewById(com.muhammed.iqbal.telugu.R.id.youtube_recycler_view);
        // use this setting to improve performance if you know that changes
        // in content do not change the layout size of the RecyclerView
        mRecyclerView.setHasFixedSize(true);

        Resources resources = getResources();
        if (resources.getBoolean(com.muhammed.iqbal.telugu.R.bool.isTablet)) {
            // use a staggered grid layout if we're on a large screen device
            mLayoutManager = new StaggeredGridLayoutManager(resources.getInteger(com.muhammed.iqbal.telugu.R.integer.columns), StaggeredGridLayoutManager.VERTICAL);
        } else {
